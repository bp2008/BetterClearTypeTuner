...
* Longer discussion (GDI vs DirectWrite/WPF scopes, implications for mixed RGB/BGR desks): [ClearType per-monitor settings](https://docs.devcentr.org/general-knowledge/explanation/cleartype-per-monitor-settings.html) · [HCI Nerdz topic](https://hci-nerdz.github.io/docs/hci-nerdz/cleartype-per-monitor.html) · [essay](https://hci-nerdz.github.io/blog/cleartype-when-monitors-disagree/).
